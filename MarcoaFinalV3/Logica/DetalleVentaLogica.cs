        ...
        public List<DetalleVenta> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    query.AppendLine(" select dv.IdDetalleVenta,dv.IdVenta,p.IdProducto,p.Nombre,p.Precio,dv.Cantidad,dv.SubTotal from DETALLE_VENTAV2 dv");
                    query.AppendLine("inner join PRODUCTOV2 p on p.IdProducto = dv.IdProducto");
