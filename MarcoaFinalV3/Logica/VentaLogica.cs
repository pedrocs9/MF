...
namespace MarcoaFinalV3.Logica
{
    ...
    {
        public static VentaLogica _instancia = null;
        ...
        public List<Venta> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("select IdVenta,IdRecepcion,Total,Estado from VENTAV2", oConexion);
        ...
        public bool Registrar(Venta objeto)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    sb.AppendLine(string.Format("insert into VENTAV2(IdRecepcion,Total,Estado) values ({0},{1},'{2}')", objeto.oRecepcion.IdRecepcion, objeto.Total, objeto.Estado));
