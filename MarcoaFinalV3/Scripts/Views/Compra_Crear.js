...
function buscarProducto() {
    if (parseInt($("#txtIdRestaurant").val()) == 0) {
        swal("Mensaje", "Debe seleccionar un restaurant primero", "warning")
        return;
    }
    tablaproducto.ajax.url($.MisUrls.url._ObtenerProductosPorTienda + "?IdRestaurant=" + $("#txtIdRestaurant").val()).load();
...
function restaurantSelect(json) {
    $("#txtIdRestaurant").val(json.IdRestaurant);
    $("#txtRucRestaurant").val(json.RUC);
    $("#txtNombreRestaurant").val(json.Nombre);
...
$('#btnAgregarCompra').on('click', function () {
    ...
    if (
        ...
        parseInt($("#txtIdRestaurant").val()) == 0 ||
    ...
    if (!existe_codigo) {
        $("<tr>").append(
            ...
            $("<td>").append($("#txtRucRestaurant").val()),
...
$('#btnTerminarGuardarCompra').on('click', function () {
    ...
    compra = "<COMPRA>" +
        ...
        "<IdRestaurant>" + $("#txtIdRestaurant").val() + "</IdRestaurant>" +
